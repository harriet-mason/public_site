...
## How we got here, and why `ggdibbler` works the way it does
...
Now, given the history of statistical graphics, (1) feels obviously wrong to me. Nowhere else do we define a plot by its underlying statistics. Otherwise, we should have central value plots or exteme value plots. We do not do this, because it doesn't really make sense to define visualisations by the statistics they visualise.  This leaves (2) which I think is a far more interesting question. 
